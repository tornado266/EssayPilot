...
class AuthSessionTests(unittest.TestCase):
    ...
    def test_browser_component_is_versioned_minimal_and_listens_for_storage(self):
        ...
        self.assertIn("() => window.top?.localStorage", component)
        self.assertIn("() => window.localStorage", component)
        self.assertNotIn("window.localStorage.getItem", component)
        self.assertNotIn("window.localStorage.setItem", component)
        self.assertNotIn("window.localStorage.removeItem", component)
