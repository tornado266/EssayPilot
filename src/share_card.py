...
def build_result_card_svg(
    *,
    ...
    gain = "尚未提交第二稿" if draft_gain is None else f"第二稿提升 {draft_gain:+.1f}"
...
<style>.brand{{font:700 26px Arial;letter-spacing:5px;fill:#17616c}}.title{{font:700 58px Arial,'Microsoft YaHei';fill:#173d46}}.band{{font:800 180px Arial;fill:#d9772d}}.label{{font:600 30px Arial,'Microsoft YaHei';fill:#315862}}.small{{font:700 28px Arial;fill:#52727a}}.score-small{{font:800 58px Arial;fill:#17616c}}.body{{font:500 32px Arial,'Microsoft YaHei';fill:#284b54}}</style>
...
<rect x="70" y="270" width="940" height="210" rx="38" fill="#fff8ef" stroke="#efd3b5" stroke-width="3"/><text x="110" y="340" class="label">IELTS Writing Task 2 · 预估总分</text><text x="110" y="445" class="band">{overall_band:.1f}</text>
{''.join(score_cells)}
